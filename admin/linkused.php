    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">INTERFACE DE GESTION DES ID</li>
            </ol>

            <div class="card mb-4">
                <div class="card-header mt-2">
                    <i class="fas fa-table me-1"></i>
                    Liste des ID déjà utilisés
                </div>
                <div class="card-header">
                    <div class="abc" style="display: flex; flex-direction: row; gap: 20px;">
                        <div >
                            <i class="fa fa-arrow-left" aria-hidden="true"></i>
                            <a href="linkunused.php" style="text-decoration: none">
                                Unused
                            </a>
                        </div>
                        <div>
                ...
                <div class="card-body">
                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                        <?php
                        $query = mysqli_query($con,"SELECT * FROM epin_list WHERE status='Used'");
                        $i = 1;
