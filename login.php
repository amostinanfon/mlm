...
if(isset($_POST['submit_login'])){
            ...
            if(mysqli_num_rows($query) > 0) {
                ...
                echo "<script>alert('Connexion réussie.'); window.location.assign('user/home.php');</script>";
            }
            else {
                echo '<script>alert("Id de Email ou Mot de passe incorrect.");window.location.assign("login.php");</script>';
            }
        }
}
?>
                                    ...
                                    <form class="user" method="POST">
                                        <div class="form-group">
                                            <input type="email" name="email" class="form-control form-control-user"
                                                ...
                                                placeholder="Entrer une Adresse Mail ..." required>
                                        </div>
                                        <div class="form-group">
